        ...
        <div className="mt-12 columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-6 space-y-6">
          {images.map((src, index) => (
            ...
            >
              ...
              <div className="absolute cursor-pointer inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-opacity duration-300 flex flex-col items-center justify-center p-4">
                <h3 className="text-xl font-bold text-[#cc9a64] opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                  Property {index + 1}
                </h3>
                <p className="mt-2 text-center text-gray-200 text-sm opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                  A stunning property with modern amenities.
                </p>
                <button className="mt-4 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 px-6 py-2 bg-[#cc9a64] text-[#0e291a] font-semibold rounded-md hover:bg-[#b88653]">
                  View Details
                </button>
              </div>
            </div>
