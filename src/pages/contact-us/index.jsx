                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`mt-1 block w-full px-4 py-2 bg-[#0e291a] border rounded-md text-greenTheme focus:ring-[#cc9a64] focus:border-[#cc9a64] hover:border-[#cc9a64] transition-colors ${
